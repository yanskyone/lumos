...
const VocabStateManager = (() => {
  ...
  const CONFUSION_EXAMPLES = {
    ...
    "beside||besides": "The book is ___ the table. ___, it is very useful.",
    ...
    "principle||principal": "It is a matter of ___.",
